...
export default function MySubmissionsPage() {
    ...
    async function deleteEntry(entryId) {
        ...
        const ok = window.confirm("Really delete this submission? This cannot be undone.");
        if (!ok) return;
                            ...
                            <article key={row.id} className="submission-card">
                                <header className="submission-head">
                                    ...
                                    <div className="submission-head-right">
                                        {!isEditing ? (
                                            <>
                                                <button type="button" onClick={() => startEdit(row)} disabled={busy}>
                                                    Edit
                                                </button>

                                                <button type="button" onClick={() => deleteEntry(row.id)} disabled={busy}>
                                                    Delete
                                                </button>
                                            </>
                                        ) : (
